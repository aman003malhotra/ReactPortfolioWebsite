              ...
              <div className="card">
                <div className="container-card bg-yellow-box">
                  ...
                  <div className="flex flex-row justify-center items-center gap-x-8 mt-3">
                    <a target="_blank" href="https://github.com/aman003malhotra/UpWorkCloneProject"><button className="text-white text-xl outline-2 outline outline-white rounded-lg px-4 py-2 text-golden">Github</button></a> 
            ...
            <Tilt>
              <div className="card">
                <div className="container-card bg-green-box">
                  ...
                  <div className="flex flex-row justify-center items-center gap-x-8 mt-3">
                    <a target="_blank" href="https://github.com/aman003malhotra/PDFEditor"><button className="text-white outline-2 text-xl outline outline-white rounded-lg px-4 py-2 text-golden">Github</button></a> 
            ...
            <Tilt>
              <div className="card">
                <div className="container-card bg-white-box">
                  ...
                  <div className="flex flex-row justify-center items-center gap-x-8 mt-3">
                    <a target="_blank" href="https://github.com/aman003malhotra/smart-attendance-system"><button className="text-white outline-2 text-xl outline outline-white rounded-lg px-4 py-2 text-golden">Github</button></a> 
            ...
            <Tilt>
              <div className="card">
                <div className="container-card bg-blue-box ">
                  ...
                  <div className="flex flex-row justify-center items-center gap-x-8 mt-3">
                    <a target="_blank" href="https://github.com/aman003malhotra/ExpenseTracker/tree/main"><button className="text-white text-xl outline-2 outline outline-white rounded-lg px-4 py-2 text-golden">Github</button></a> 
                    <a target="_blank" href="https://github.com/aman003malhotra/ExpenseTracker/tree/main"><button className="text-white outline-2 outline text-xl outline-white rounded-lg px-4 py-2 text-golden">Link</button></a>
                  </div>
                </div>
              </div>
            </Tilt>
