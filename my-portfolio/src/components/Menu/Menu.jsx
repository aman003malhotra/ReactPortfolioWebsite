    ...
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
     ...
     <div className="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-[transparent] md:flex-row md:space-x-8 md:mt-0 md:border-0 ">
          ...
          <li>
            <a target='_blank' href="https://drive.google.com/file/d/1zmBbNVlTBHV-1iMZVa6JE0_1Tu5uepAW/view?usp=drive_link" className="text-xl block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 ">Resume</a>
          </li>
          <li>
            <a target='_blank' href="https://medium.com/@aman003malhotra" className="text-xl block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 ">Blogs</a>
          </li>
        </ul>
      </div>
    </div>
